...
def get_args():
    ...
    parser.add_argument("--descriptions", help="The path to the folder with all city images", required=True, type=str)
...
import joblib
joblib.dump(boost_classifier, 'Franco_Detect\\models\\city_models\\boost_classifier.pkl')
joblib.dump(forest_classifier, 'Franco_Detect\\models\\city_models\\forest_classifier.pkl')
joblib.dump(svm_classifier, 'Franco_Detect\\models\\city_models\\svm_classifier.pkl')
joblib.dump(classifier, 'Franco_Detect\\models\\city_models\\log_classifier.pkl')
joblib.dump(adaboost_classifier, 'Franco_Detect\\models\\city_models\\adaboost_classifier.pkl')
joblib.dump(lda_classifier, 'Franco_Detect\\models\\city_models\\lda_classifier.pkl')
joblib.dump(sgd_classifier, 'Franco_Detect\\models\\city_models\\sgd_classifier.pkl')